...
namespace BubbleSortModified
{
    public partial class Burbuja : Form
    {
        ...
        private void brnOrdenar_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("El tiempo de ordenamiento es: " + tiempo.TotalSeconds + " segundos");
